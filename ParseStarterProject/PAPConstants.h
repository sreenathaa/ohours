...
extern NSString *const kPAPUserDefaultsCacheFlashUserKey;
...
extern NSString *const UserInfoChangedNotification;
...
extern NSString *const kPAPActivityPhotoStartDateKey;
...
extern NSString *const kPAPActivityTypeInvite;
...
extern NSString *const kPAPUserTwitNameKey;
extern NSString *const kPAPUserTwitIdKey;
...
extern NSString *const kPAPPhotoStartDateKey;

extern NSString *const kPAPPhotoNumOfLikesKey;
...
extern NSString *const kAPNSSoundTypeKey;
...
extern NSString *const kPAPPushPayloadActivityInviteKey;
