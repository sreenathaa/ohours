...
NSString *const kPAPUserDefaultsActivityFeedViewControllerLastRefreshKey    = @"com.parse.Heyday.userDefaults.activityFeedViewController.lastRefresh";
NSString *const kPAPUserDefaultsCacheFacebookFriendsKey                     = @"com.parse.Heyday.userDefaults.cache.facebookFriends";

NSString *const kPAPUserDefaultsCacheFlashUserKey                     = @"com.parse.Heyday.userDefaults.cache.flashUser";
...
NSString *const PAPAppDelegateApplicationDidReceiveRemoteNotification           = @"com.parse.Heyday.appDelegate.applicationDidReceiveRemoteNotification";
NSString *const PAPUtilityUserFollowingChangedNotification                      = @"com.parse.Heyday.utility.userFollowingChanged";
NSString *const PAPUtilityUserLikedUnlikedPhotoCallbackFinishedNotification     = @"com.parse.Heyday.utility.userLikedUnlikedPhotoCallbackFinished";
NSString *const PAPUtilityDidFinishProcessingProfilePictureNotification         = @"com.parse.Heyday.utility.didFinishProcessingProfilePictureNotification";
NSString *const PAPTabBarControllerDidFinishEditingPhotoNotification            = @"com.parse.Heyday.tabBarController.didFinishEditingPhoto";
NSString *const PAPTabBarControllerDidFinishImageFileUploadNotification         = @"com.parse.Heyday.tabBarController.didFinishImageFileUploadNotification";
NSString *const PAPPhotoDetailsViewControllerUserDeletedPhotoNotification       = @"com.parse.Heyday.photoDetailsViewController.userDeletedPhoto";
NSString *const PAPPhotoDetailsViewControllerUserLikedUnlikedPhotoNotification  = @"com.parse.Heyday.photoDetailsViewController.userLikedUnlikedPhotoInDetailsViewNotification";
NSString *const PAPPhotoDetailsViewControllerUserCommentedOnPhotoNotification   = @"com.parse.Heyday.photoDetailsViewController.userCommentedOnPhotoInDetailsViewNotification";


NSString *const UserInfoChangedNotification                                     = @"com.parse.Heyday.utility.userInfoChanged";
...
NSString *const kPAPActivityPhotoKey       = @"event";

NSString *const kPAPActivityPhotoStartDateKey       = @"eventStartDate";
...
NSString *const kPAPActivityTypeInvite       = @"invite";
...
NSString *const kPAPUserTwitNameKey                             = @"twitName";
NSString *const kPAPUserTwitIdKey                               = @"twitId";

#pragma mark - Photo Class
// Class key
NSString *const kPAPPhotoClassKey = @"Event";
...
NSString *const kPAPPhotoTitleKey           = @"textContent";
NSString *const kPAPPhotoStartDateKey       = @"startDate";
...
NSString *const kAPNSSoundTypeKey = @"ding";  //tri-tone
...
NSString *const kPAPPushPayloadActivityInviteKey   = @"i";
